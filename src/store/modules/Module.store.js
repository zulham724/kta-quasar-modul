...
const mutations = {
  ...
  setModuleContentAudio(state, payload) {
    state.build.contents[payload.index].audio = payload.audio;
  },
...
const actions = {
  ...
  show({ commit }, payload) {
    return new Promise((resolve, reject) => {
      axios
        .get(`${this.state.Setting.url}/api/v1/module/${payload.module_id}`)
        .then(res => {
          //commit("set", { items: res.data.grades });
          resolve(res);
        })
  ...
  store({ commit }, payload) {
    ...
    return new Promise((resolve, reject) => {
      axios
        .post(`${this.state.Setting.url}/api/v1/module`, form, {
          headers: {
  ...
  destroy({ commit }, payload) {
    return new Promise((resolve, reject) => {
      axios
        .delete(`${this.state.Setting.url}/api/v1/module/${payload.moduleId}`)
        .then(res => {
          //commit("set", { items: res.data.grades });
          resolve(res);
        })
  ...
  getModulesByEducationalLevel() {
    return new Promise((resolve, reject) => {
      axios
        .get(`${this.state.Setting.url}/api/v1/modules/getmodulescount`)
        .then(res => {
  ...
  getLikedCount({ commit }) {
    return new Promise((resolve, reject) => {
      axios
        .get(`${this.state.Setting.url}/api/v1/modules/getlikedcount`)
        .then(res => {
  ...
  getLikesCount({ commit }) {
    return new Promise((resolve, reject) => {
      axios
        .get(`${this.state.Setting.url}/api/v1/modules/getlikescount`)
        .then(res => {
  ...
  getPublishedModules({ commit }) {
    return new Promise((resolve, reject) => {
      axios
        .get(`${this.state.Setting.url}/api/v1/modules/getpublish`)
        .then(res => {
  ...
  getUnpublishedModules({ commit }) {
    return new Promise((resolve, reject) => {
      axios
        .get(`${this.state.Setting.url}/api/v1/modules/getunpublish`)
        .then(res => {
  ...
  getLatestModules({ commit }) {
    return new Promise((resolve, reject) => {
      axios
        .get(`${this.state.Setting.url}/api/v1/modules/getalllatest`)
        .then(res => {
  ...
  like({ commit }, payload) {
    return new Promise((resolve, reject) => {
      ...
      axios
        .post(
          `${this.state.Setting.url}/api/v1/modules/${access.module_id}/likes`
        )
        .then(res => {
          resolve(res);
        })
  ...
  dislike({ commit }, payload) {
    return new Promise((resolve, reject) => {
      ...
      axios
        .delete(
          `${this.state.Setting.url}/api/v1/module/${access.module_id}/dislike`
        )
        .then(res => {
          resolve(res);
        })
