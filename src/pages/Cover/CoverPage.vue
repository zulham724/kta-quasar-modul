...
<div>
    ...
    <q-tab-panels v-model="tab" animated style="height:-webkit-fill-available">
        <q-tab-panel name="template" style="height:100%;background-color:white">
            ...
            <div class="row">
                <q-intersection v-for="(template,n) in filteredTemplates" :key="`tempate${n}`" style="min-height:100px;width:50%" class="q-pa-sm">
        ...
        <q-tab-panel name="self" style="height:100%;background-color:white">
            ...
            <div class="row" style="">
                <div v-for="(template,n) in filteredOwnedTemplates" :key="`owned_template${n}`" style="width:50%" class="q-pa-sm">
